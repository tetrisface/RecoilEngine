...
namespace QTPFS {
	...
	private:
		struct ReplayCheckpointPathState {
			...
			ReplayCheckpointPathPayload path;
			...
			bool hasSearchModeSnapshot = false;
			ReplayCheckpointPathPayload searchModeSnapshot;
		};

		void CaptureReplayCheckpointPathStates();
		void CaptureReplayCheckpointPathSearchStates();
		void CaptureReplayCheckpointEmptyEntities();
		void SerializeReplayCheckpointPathPayload(creg::ISerializer* s, ReplayCheckpointPathPayload& state);
		void SerializeReplayCheckpointPathState(creg::ISerializer* s, ReplayCheckpointPathState& state);
		void SerializeReplayCheckpointPathSearchState(creg::ISerializer* s, ReplayCheckpointPathSearchState& state);
		void RestoreReplayCheckpointSharedPathCaches();
		void RestoreReplayCheckpointPathComponentOrder();
		void RestoreReplayCheckpointPathSearchesForLoad();
	...
	private:
		...
		std::vector<ReplayCheckpointPathSearchState> replayCheckpointPathSearchStates;
		...
		bool replayCheckpointNodeLayersLoaded = false;
